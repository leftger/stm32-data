...
const PERIMAP: &[(&str, (&str, &str, &str))] = &[
    ...
    ("STM32N6.*:ADC:.*", ("adc", "n6", "ADC")),
    ("STM32C0.*:ADC\\d*_COMMON:.*", ("adccommon", "c0", "ADC_COMMON")),
    ("STM32C5.*:ADC\\d*_COMMON:.*", ("adccommon", "c5", "ADC_COMMON")),
    ...
    ("STM32N6.*:ADC\\d*_COMMON:.*", ("adccommon", "n6", "ADC_COMMON")),
